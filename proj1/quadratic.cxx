...
namespace my_math
{
    ...
    {
        std::vector<double> roots = getRoots();
        return roots[0];
    }
    ...
    std::vector<double> quadratic::getRoots() const
    {
        ...
        else
        {
            ...
            {
                cout << "Precondition Failed: " << "The given function has no real roots" << '\n';
            }
        }
